...
#
# Generated by export_simulation on Fri Dec 04 21:26:08 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './cateen.sh' script.
...
./cateen.sh -noclean_files

For more information on the script, please type './cateen.sh -help'.
