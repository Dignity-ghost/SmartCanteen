	...
	while(1)
	{
		...
		{         
            ...
            Send_Word(" g\n");
						...
						Send_ASCII(Weight_Maopi/1000000000 + 0X30);
						Send_ASCII(Weight_Maopi%100000000/10000000 + 0X30);
						Send_ASCII(Weight_Maopi%10000000/1000000 + 0X30);
						Send_ASCII(Weight_Maopi%1000000/100000 + 0X30);
						Send_ASCII(Weight_Maopi%100000/10000 + 0X30);
						Send_ASCII(Weight_Maopi%10000/1000 + 0X30);
						Send_ASCII(Weight_Maopi%1000/100 + 0X30);
						Send_ASCII(Weight_Maopi%100/10 + 0X30);
						Send_ASCII(Weight_Maopi%10 + 0X30);
						Send_Word(" maopi\n");
