...
#
# Generated by export_simulation on Fri Nov 20 15:53:59 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './rfid.sh' script.
...
./rfid.sh -noclean_files

For more information on the script, please type './rfid.sh -help'.
