...
HD_PWD='C:/Users/jinha/Desktop/XD_Xie/zynq/zynq.runs/test_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_processing_system7_0_1.tcl
