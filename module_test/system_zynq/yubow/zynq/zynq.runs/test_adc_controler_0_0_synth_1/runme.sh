...
HD_PWD='C:/Users/jinha/Desktop/XD_Xie/zynq/zynq.runs/test_adc_controler_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_adc_controler_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_adc_controler_0_0.tcl
