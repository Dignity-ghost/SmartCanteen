...
################################################################
# This is a generated script based on design: hx711_zynq
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: hx711_package_0, and set properties
  set hx711_package_0 [ create_bd_cell -type ip -vlnv yubow:user:hx711_package:1.0 hx711_package_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins hx711_package_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net dout_0_1 [get_bd_ports dout_0] [get_bd_pins hx711_package_0/dout]
  connect_bd_net -net hx711_package_0_pd_sck [get_bd_ports pd_sck_0] [get_bd_pins hx711_package_0/pd_sck]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins hx711_package_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins hx711_package_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hx711_package_0/S00_AXI/S00_AXI_reg] SEG_hx711_package_0_S00_AXI_reg
